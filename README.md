...
| [`@sorandomains/holder`](packages/holder/) | 0.5.1 | Name holders: records, payment memos, reverse/Primary and transfers |
| [`@sorandomains/mcp`](packages/mcp/) | 0.7.1 | AI agents: hosted read tools and locally signed management tools |
